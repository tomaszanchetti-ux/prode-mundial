...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --max-instances=5 \
  --timeout=60s \
  --set-env-vars="^@@^NODE_ENV=production@@PRODE_ALLOWED_ORIGINS=${PRODE_ALLOWED_ORIGINS:-https://prode-mundial-2026--prode-mundial-4e419.europe-west4.hosted.app,https://prode-mundial-4e419.web.app,https://prode-mundial-4e419.firebaseapp.com,http://localhost:3000}" \
